...
export declare class SearcherClient {
     ...
     */
    onProgramUpdate(programs: PublicKey[], successCallback: (transactions: VersionedTransaction[]) => void, errorCallback: (e: Error) => void): () => void;
    /**
     ...
     */
    programUpdates(programs: PublicKey[], onError: (e: Error) => void): AsyncGenerator<VersionedTransaction[]>;
    /**
     ...
     * @returns A function to cancel the subscription
     */
    onAccountUpdate(accounts: PublicKey[], successCallback: (transactions: VersionedTransaction[]) => void, errorCallback: (e: Error) => void): () => void;
    /**
     ...
     */
    accountUpdates(accounts: PublicKey[], onError: (e: Error) => void): AsyncGenerator<VersionedTransaction[]>;
    /**

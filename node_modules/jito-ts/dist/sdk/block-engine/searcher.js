...
class SearcherClient {
     ...
     */
    onProgramUpdate(programs, successCallback, errorCallback) {
     ...
     */
    async *programUpdates(programs, onError) {
        const stream = this.client.subscribeMempool({
            programV0Sub: {
                programs: programs.map(p => p.toString()),
            },
     ...
     * @returns A function to cancel the subscription
     */
    onAccountUpdate(accounts, successCallback, errorCallback) {
        const stream = this.client.subscribeMempool({
            wlaV0Sub: {
     ...
     */
    async *accountUpdates(accounts, onError) {
        const stream = this.client.subscribeMempool({
            wlaV0Sub: {
                accounts: accounts.map(a => a.toString()),
            },

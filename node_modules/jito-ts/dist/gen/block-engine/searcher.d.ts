...
export declare const MempoolSubscription: {
    ...
    } & { [K_4 in Exclude<keyof I, keyof MempoolSubscription>]: never; }>(base?: I | undefined): MempoolSubscription;
    fromPartial<I_1 extends {
        programV0Sub?: {
            programs?: string[] | undefined;
        } | undefined;
        ...
        programV0Sub?: ({
            ...
            programs?: (string[] & string[] & { [K_5 in Exclude<keyof I_1["programV0Sub"]["programs"], keyof string[]>]: never; }) | undefined;
        } & { [K_6 in Exclude<keyof I_1["programV0Sub"], "programs">]: never; }) | undefined;
        wlaV0Sub?: ({
            accounts?: string[] | undefined;
        } & {
            accounts?: (string[] & string[] & { [K_7 in Exclude<keyof I_1["wlaV0Sub"]["accounts"], keyof string[]>]: never; }) | undefined;
        } & { [K_8 in Exclude<keyof I_1["wlaV0Sub"], "accounts">]: never; }) | undefined;
    } & { [K_9 in Exclude<keyof I_1, keyof MempoolSubscription>]: never; }>(object: I_1): MempoolSubscription;
};

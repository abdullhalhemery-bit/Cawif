...
exports.BlockHeight = exports.UnixTimestamp = exports.Rewards = exports.Reward = exports.ReturnData = exports.UiTokenAmount = exports.TokenBalance = exports.CompiledInstruction = exports.InnerInstructions = exports.TransactionError = exports.TransactionStatusMeta = exports.MessageAddressTableLookup = exports.MessageHeader = exports.Message = exports.Transaction = exports.ConfirmedTransaction = exports.ConfirmedBlock = exports.rewardTypeToJSON = exports.rewardTypeFromJSON = exports.RewardType = exports.protobufPackage = void 0;
/* eslint-disable */
...
exports.InnerInstructions = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        ...
        for (const v of message.instructions) {
            exports.CompiledInstruction.encode(v, writer.uint32(18).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
    ...
    fromPartial(object) {
        ...
        message.instructions = ((_b = object.instructions) === null || _b === void 0 ? void 0 : _b.map((e) => exports.CompiledInstruction.fromPartial(e))) || [];
        return message;
    },
};
